{{-- <div id="main-content" class="relative my-[4rem] mr-6 h-[60%] bg-gray-50 lg:ml-64 dark:bg-gray-900">
    <main>
                    ...
                    <div id="dropdown"
                        ...
                        <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                            <li class="flex items-center">
                                ...
                                <label for="apple"
                                    class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Completed
                                    (56)
                                </label>
                            </li>
                            <li class="flex items-center">
                                <input id="fitbit" type="checkbox" value="" checked
                                    class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                                <label for="fitbit"
                                    class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">Cancelled
                                    (56)
                                </label>
                            </li>
                            <li class="flex items-center">
...
<div class="mx-12 p-6  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <section class="p-6 bg-white shadow rounded-lg my-4">
            <h2 class="text-xl font-bold mb-4">Staff Overview</h2>
            <!-- Responsive Grid -->
            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="p-4 bg-gray-100 rounded-lg text-center">
                    ...
                    <p class="text-sm text-gray-500">2 new updates</p>
                </div>
            </div>
        </section>
    ...
    <section class="p-6 bg-white shadow rounded-lg">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-bold">Casual Leave</h2>
            <button class="px-4 py-2 bg-black text-white rounded-md">Add Shift</button>
        </div>
        <div class="overflow-x-auto">
            <table id="leaveTable" class="w-full border-collapse border border-gray-200">
                <thead>
                    <tr class="bg-gray-100 text-left text-sm">
                        ...
                        <th class="border px-4 py-2">Leave Date</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="border px-4 py-2">2023-11-22</td>
                        <td class="border px-4 py-2">Approved</td>
                        <td class="border px-4 py-2">
                            <button class="editBtn px-2 py-1 bg-black text-white text-xs rounded">Edit</button>
                        </td>
                    </tr>
