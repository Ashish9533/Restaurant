<div class="fixed top-0 left-0 z-50 ml-12 w-full justify-content-center mt-4 bg-white rounded-lg dark:bg-gray-800 shadow-lg">
   <div class="container mx-auto flex justify-between items-center">
       <div class="flex items-center justify-start">
        ...
        <div class="flex items-center mt-[-2rem]">
          <button class="bg-white text-black px-6 w-28 py-2 mr-[-1.5rem] rounded-[24rem] border-gray-500">BOH</button>
