<nav class="fixed top-0 left-0 z-50 w-full justify-content-center ml-12 mr-24  mt-4 bg-white rounded-lg dark:bg-gray-800 shadow-lg">
   <div class="container mx-auto flex justify-between items-center">
       ...
       <div class="flex items-center mt-[-2rem] w-[12rem] rounded-[2rem]">
        <div class="px-[22px] ">
          <button class="bg-white text-black px-6 py-2 mr-[-1.5rem] rounded-[24rem] border-gray-500">BOH</button>
          <button class="bg-black text-white px-6 py-2 rounded-[24rem]">FOH</button>
        </div>
