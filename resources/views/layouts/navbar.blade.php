<div class="fixed top-0 left-0 z-50 ml-12 w-full p-2 justify-content-center mt-4 bg-white rounded-lg dark:bg-gray-800 shadow-lg">
    <div class="container mx-auto flex justify-between items-center">
        <div class="flex items-center justify-start">
          ...
          <a href="#" class="flex ml-2 md:mr-24 ">
           <button class="bg-black text-white font-semibold  px-6 py-2 rounded-[24rem]">LOGO</button>
            {{-- <img src="" class="h-8 mr-3 bg-black text-white px-6 py-2 rounded-[24rem]" alt="Logo" /> --}}
            {{-- <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">ROI Restaurant</span> --}}
          </a>
         ...
         <div class="flex items-center mt-[-2rem]">
           <button class="bg-white text-black font-semibold px-6 w-28 py-2 mr-[-1.5rem] rounded-[24rem] border-gray-500">BOH</button>
           <button class="bg-black text-white font-semibold  px-6 py-2 rounded-[24rem]">FOH</button>
         </div>
