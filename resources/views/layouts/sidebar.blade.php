{{-- <aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
        ...
        <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
          <ul class="pb-2 space-y-2">
            ...
            <li>
              <a href="" class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                  ...
                  <span class="ml-3" sidebar-toggle-item>Admin Overview</span>
              </a>
            </li>
            <li>
              <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-layouts" data-collapse-toggle="dropdown-layouts">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>User Access</span>
            ...
            <li>
              <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-crud" data-collapse-toggle="dropdown-crud">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Statements</span>
                  <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </button>
            ...
            <li>
              <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Payments</span>
                  <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </button>
            ...
            <li>
              <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-auth" data-collapse-toggle="dropdown-auth">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Sale Report</span>
                  <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </button>
            ...
            <li>
              <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" aria-controls="dropdown-playground" data-collapse-toggle="dropdown-playground">
                  ...
                  <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Staff Management</span>
                  <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </button>
          ...
          <div class="pt-2 space-y-2">
            <a href="#" target="_blank" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
              ...
              <span class="ml-3" sidebar-toggle-item>System Security</span>
            </a>
            <a href="#" target="_blank" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
              <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path></svg>
              <span class="ml-3" sidebar-toggle-item>Custom Branding</span>
            </a>
  ...
  <aside id="sidebar" class="fixed left-0 mx-2 top-0 mt-24 h-[29rem] w-16 rounded-[24px] bg-black text-white transition-all duration-300 ease-in-out flex-col flex-shrink-0 pt-16 font-normal lg:flex hidden">
    <div class="flex flex-col h-full mt-[-3rem]">
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200 " data-label="Admin Overview">
        <span class="text-gray-300">🏠</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">Admin Overview</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="User Access">
        <span class="text-gray-300">👤</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">User Access</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="Statements">
        <span class="text-gray-300">📄</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">Statements</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="Payments">
        <span class="text-gray-300">💳</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">Payments</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="Sale Report">
        <span class="text-gray-300">📊</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">Sale Report</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="Staff Management">
        <span class="text-gray-300">👥</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">Staff Management</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="System Security">
        <span class="text-gray-300">🛡️</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">System Security</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="Custom Branding">
        <span class="text-gray-300">🎨</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">Custom Branding</span>
      </button>
      <button class="sidebar-item flex items-center px-4 py-3 hover:bg-gray-800 transition-colors duration-200" data-label="Settings">
        <span class="text-gray-300">⚙️</span>
        <span class="ml-2 text-gray-300 hidden sidebar-text">Settings</span>
      </button>
    </div>
  </aside>
